      ...
      <div className="relative container-default text-center">
        <AnimateOnScroll>
          <h2 className="text-display-lg leading-tight">
            ...
            <br />
            <span className="text-accent">Start Reading It.</span>
          </h2>
        </AnimateOnScroll>

        <AnimateOnScroll delay={100}>
          <p className="mt-6 text-body-lg text-subtle max-w-2xl mx-auto">
        ...
        <AnimateOnScroll delay={200}>
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              href="#pricing"
              className="w-full sm:w-auto btn-primary px-10 py-4 text-base"
            >
              Get Started
            </a>
            <a
              href="#"
              className="w-full sm:w-auto btn-secondary px-10 py-4 text-base"
            >
              See Sample Results
            </a>
          </div>
        ...
        <AnimateOnScroll delay={300}>
          <div className="mt-16 flex flex-wrap items-center justify-center gap-8 text-dim">
            <div className="flex items-center gap-2">
              ...
              <span className="text-body-sm">HIPAA Compliant</span>
            </div>
            <div className="flex items-center gap-2">
              <svg
                className="w-5 h-5"
              ...
              <span className="text-body-sm">256-bit Encryption</span>
            </div>
            <div className="flex items-center gap-2">
              <svg
                className="w-5 h-5"
